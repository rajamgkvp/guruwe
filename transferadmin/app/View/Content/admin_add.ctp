...
<?php echo $this->Form->create('Content' ,array('url'=>'/admin/content/add/', 'enctype'=>'multipart/form-data', 'class'=>'mainForm')); ?>
<!-- Input text fields -->
<fieldset>
	<div class="widget first">
		<div class="head"><h5 class="iList">Add New Page</h5></div>
		
			<div class="rowElem noborder"><label style="width:auto;">Page Title:</label><div class="formRight" style="width:500px; margin:12px 18px 12px 0;">
			...
			<div class="rowElem noborder"><label style="width:auto;">Page Header Title:</label><div class="formRight" style="width:500px; margin:12px 18px 12px 0;">
				<?php echo $this->Form->text('Content.title'); ?>
			</div><div class="fix"></div></div>
			
			
			<div class="rowElem noborder"><label style="width:auto;">Short Description:</label><div class="formRight" style="width:500px; margin:12px 18px 12px 0;">
				<?php echo $this->Form->text('Content.short_description'); ?>
			</div><div class="fix"></div></div>
		
			<div class="rowElem noborder"><label style="width:auto;">Content:</label><div class="formRight" style="width:500px;">
