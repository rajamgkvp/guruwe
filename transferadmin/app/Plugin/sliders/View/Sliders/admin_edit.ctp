...
<?php echo $this->Form->create(null ,array('url'=>'/admin/sliders/sliders/edit/'.$pid, 'enctype'=>'multipart/form-data', 'class'=>'mainForm')); ?>
<!-- Input text fields -->
<fieldset>
	<div class="widget first">
		<div class="head"><h5 class="iList">Edit Slider</h5></div>
			<input type="hidden" name="data[Slider][id]" value="<?php echo $pid?>">
			...
			<div class="rowElem noborder"><label style="width:auto;">Image:</label><div class="formRight" style="width:590px;">
				<?php echo $this->Form->file('Slider.image_name', array('class'=>'validate[required]')); ?>
...
<script>
	function load_translation_file() {
		...
		var language 	= jQuery("#TipLanguage").val();
