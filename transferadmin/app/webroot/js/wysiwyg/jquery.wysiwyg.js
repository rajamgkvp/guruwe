...
(function ($) {
	...
	function Wysiwyg() {
		...
		this.defaults = {
html: '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" style="margin: 0"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style>@import url(http://fonts.googleapis.com/css?family=Open+Sans:400);@import url(http://fonts.googleapis.com/css?family=Open+Sans:700);</style></head><body style="margin: 0; padding: 0; font-size:14px; ; color: #707070; font-weight:400; font-family: Open Sans;"><div class="oneone">INITIAL_CONTENT</div></body></html>',
			debug: false,
			controls: {},
			css: {},
			events: {},
			...
			toolbarHtml: 'Reply<ul role="menu" class="toolbar"></ul>',
