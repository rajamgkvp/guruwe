...
if($_SERVER['HTTP_HOST'] == "localhost"){
	define('SITE_URL', 'http'.$s.'://'.$_SERVER['HTTP_HOST'].'/gurutransfer/transferadmin/');
	define("ADMIN_EMAIL", 'rishabh.trivedi08@gmail.com');
} else {
	define('SITE_URL', 'http'.$s.'://'.$_SERVER['HTTP_HOST'].'/transferadmin/');
	define("ADMIN_EMAIL", 'rishabh.trivedi08@gmail.com');
}
...
define('IMG_FOLDER', WWW_ROOT.'img'.DS);
define('IMG_URL', SITE_URL.'img/');
define('IMAGE_URL', SITE_URL.'image/');
define('ADMIN_IMG_URL', SITE_URL.'img/admin/');
define('ADMIN_IMAGE_URL', SITE_URL.'images/admin/');

define('DATE_FORMAT', 'M, j Y');
define('DATE_TIME', 'd M Y, h:i:s A');

define('LANGUAGES', serialize(array(
					'en' => 'English',
					'fr' => 'French',
			)));
define('LANGUAGE_FOLDERS', serialize(array(
					'en' => 'eng',
					'fr' => 'fra',
			)));
define('DEFAULT_LANGUAGE', 'en');
define('COUNTRYCODE_API_KEY', '31194ef33e97f232e4b7afa368212dc64e8ef226f873fade2df63f954253b6e5');
