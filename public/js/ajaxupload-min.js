...
(function(c, g) {
    ...
    var k = {
        ...
        l = Class.extend({
            ...
            renderHtml: function() {
                var a = this.settings,
                    b = this.size;//this.AU.formatSize(this.size);
    ...
    t.prototype = {
        ...
        renderHtml: function() {
            var a = this.settings;
            this.mainWrapper = c('<div class="ax-main-container" />').appendTo(this.container);
            ...
            this.browse_c = c('<a class="' + e + '" title="' + f("Add files") + '" />').append('<span class="' + g + '"></span> <span class="ax-text">' + f("Add files") + "</span>").appendTo(this.mainWrapper);
            ...
            this.fileList = c('<ul class="ax-file-list" />').prependTo(this.mainWrapper);
