    ...
    <div class="container">
        <div class="content row">
            <div class="col-sm-12 col-md-12">
                <div class="row content-page payments-plans-compare">
                    <div class="primary-header-container">
                        <h2 class="compare-section__heading">Choose the right GuruTransfer for you</h2>
                    </div>

                    <table class="business-comparison-matrix business-comparison-matrix--three-columns business-comparison-matrix--plans-comparison" id="pyxl4598178378180880812" cellspacing="0">
                        <thead class="business-comparison-breakdown__table-head" style="transform: translateY(0px);">
                            <tr>
                                <td class="business-comparison-breakdown__td column--features"></td>
                                <td colspan="1" class="business-comparison-breakdown__td column--pro">For individuals</td>
                                <td colspan="2" class="business-comparison-breakdown__td column--dfb">For teams</td>
                            </tr>
                            <tr>
                                <td class="business-comparison-breakdown__td column--features"></td>
                                <td class="business-comparison-breakdown__td column--pro">Pro</td>
                                <td class="business-comparison-breakdown__td column--dfb">Business</td>
                                <td class="business-comparison-breakdown__td column--enterprise">Enterprise</td>
                            </tr>
                            <tr>
                                <td class="business-comparison-breakdown__td column--features"></td>
                                <td class="business-comparison-breakdown__td column--pro"><span data-monthly="$9.99 / month" class="price--toggle" data-annual-by-month="$8.25 / month">$8.25 / month</span></td>
                                <td class="business-comparison-breakdown__td column--dfb"><span data-monthly="$15 / user / month" class="price--toggle" data-annual-by-month="$12.50 / user / month">$12.50 / user / month</span></td>
                                <td class="business-comparison-breakdown__td column--enterprise">Contact us for pricing</td>
                            </tr>
                            <tr>
                                <td class="business-comparison-breakdown__td column--features"></td>
                                <td class="business-comparison-breakdown__td column--pro"><a href="/pro" class="button-secondary">Get started</a> </td>
                                <td class="business-comparison-matrix__td--button business-comparison-breakdown__td column--dfb">
                                    <a href="/business/try" class="button-secondary">Try for free</a>
                                    <p class="business-comparison-matrix__cta business-comparison-matrix__cta--secondary">or <a href="/business/buy">purchase now</a></p>
                                </td>
                                <td class="business-comparison-breakdown__td column--enterprise"><a href="/enterprise/contact" class="button-secondary">Contact us</a> </td>
                            </tr>
                        </thead>
                        <tbody class="business-comparison-breakdown__table-body">
                            <tr>
                                <td colspan="5" class="business-comparison-breakdown__header business-comparison-breakdown__td column--features">Dropbox core features</td>
                            </tr>
                            <tr>
                                <td class="business-comparison-breakdown__td column--features">Storage</td>
                                <td class="business-comparison-breakdown__td column--pro">1 TB</td>
                                <td class="business-comparison-breakdown__td column--dfb">As much space as needed</td>
                                <td class="business-comparison-breakdown__td column--enterprise">As much space as needed</td>
                            </tr>
                            <tr>
